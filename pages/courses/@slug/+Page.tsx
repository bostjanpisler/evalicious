	...
	return (
		<>
					...
					<div className="mt-10 lg:mt-0 lg:w-80 lg:flex-shrink-0">
						<div className="lg:sticky lg:top-4 rounded-2xl border border-border bg-card p-6 shadow-sm">
							...
							<div className="mt-6 border-t border-border pt-6">
								{courseTarget ? (
									<Button asChild size="lg" className="h-auto w-full rounded-xl py-3.5 text-base">
										<a href={courseTarget}>{courseCtaLabel}</a>
									</Button>
								) : (
			...
			<div className="fixed bottom-0 left-0 right-0 z-40 border-t border-border bg-background p-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] lg:hidden">
				{courseTarget ? (
					<Button asChild size="lg" className="h-auto w-full rounded-xl py-3 text-base">
						<a href={courseTarget}>{courseCtaLabel}</a>
					</Button>
				) : (
